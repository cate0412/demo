...
public class StompErrorHandler {//extends StompSubProtocolErrorHandler {
     ...
     * @param ex 발생한 예외
     * @return 오류 메시지를 포함한 ChatMessage 객체
     */
    /*
    @Override
    public ChatMessage<byte[]> handleClientMessageProcessingError(
            ChatMessage<byte[]> clientMessage,
            Throwable ex) {
    ...
    /**
     * 오류 메시지를 포함한 ChatMessage 객체를 생성
     *
     * @param errorMessage 오류 메시지
     * @return 오류 메시지를 포함한 ChatMessage 객체
     */
    /*
    private ChatMessage<byte[]> errorMessage(String errorMessage) {
